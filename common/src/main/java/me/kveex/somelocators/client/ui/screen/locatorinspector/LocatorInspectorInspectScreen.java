...
public class LocatorInspectorInspectScreen extends LocatorInspectorRelatedScreen {
    ...
    protected void init() {
        ...
        LocatorComponent lodestoneComponent = this.inspectedStack.get(ModComponents.LODESTONE_POINT_COMPONENT.get());
        PlayerLocatorComponent playerComponent = this.inspectedStack.get(ModComponents.PLAYER_TRACKER_COMPONENT.get());
        ...
        if (lodestoneComponent != null) {
            ...
            int fullSeconds = Services.CONFIG.playerLocatorTrackingTime().get();
