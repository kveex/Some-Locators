...
public class ButtonElement extends AbstractButton {
    ...
    private static final Identifier BUTTON = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "widget/redstone_button");
    private static final Identifier BUTTON_DISABLED = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "widget/redstone_button_disabled");
    private static final Identifier BUTTON_HOVERED = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "widget/redstone_button_hover");
    private static final Identifier BUTTON_PRESSED = Identifier.fromNamespaceAndPath(Constants.MOD_ID, "widget/redstone_button_press");
    ...
    public static Builder builder(Component text, OnPress onPress) {
    ...
    public static class Builder {
        ...
        public Builder(Component text, OnPress onPress) {
            this.text = text;
            this.onPress = onPress;
        }
