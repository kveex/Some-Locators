...
public class LocatorInspectorCopyScreen extends LocatorInspectorRelatedScreen {
    ...
    protected void init() {
        super.init();
        if (this.punchCard.has(ModComponents.LODESTONE_POINT_COMPONENT.get())) {
    ...
    private void initUI(ItemStack stackFrom, ItemStack stackTo, boolean showRewriteWarning) {
        ...
        LocatorComponent component = stackFrom.get(ModComponents.LODESTONE_POINT_COMPONENT.get());
        ...
        this.copyButton = ButtonElement.builder(copButtonText, button -> {
            ...
            stackTo.set(ModComponents.LODESTONE_POINT_COMPONENT.get(), new LocatorComponent(selectedPoints.getFirst(), selectedPoints, false));
