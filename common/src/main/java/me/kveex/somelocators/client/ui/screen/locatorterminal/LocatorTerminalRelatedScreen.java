...
public class LocatorTerminalRelatedScreen extends Screen {
    ...
    protected LocatorTerminalRelatedScreen(BlockPos blockPos) {
    ...
    public void tick() {
        ...
        if (!state.is(ModBlocks.LOCATOR_TERMINAL.get())) {
            blockMoved = true;
            onClose();
        }
    }
